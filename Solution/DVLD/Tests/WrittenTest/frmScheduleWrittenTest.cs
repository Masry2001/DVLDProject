...
namespace DVLD.Tests.WrittenTest
{
    public partial class frmScheduleWrittenTest : Form
    {
        ...
        public frmScheduleWrittenTest(int LDLAppID, int AppointmentID)
        {
            InitializeComponent();

            this.LDLAppID = LDLAppID;
            TestTypeID = 2; // WrittenTest
        ...
        private void FillFrmScheduleWrittenTest()
        {
        ...
        private void HandleRetakeTestGroubBox()
        {
            ...
            if (_Mode == enMode.AddNewTestAppoinment || this.AppointmentID == FirstTestAppointmentID)
            {
                ...
                gbRetakeWrittenTest.Enabled = false;
            ...
            else if (_Mode == enMode.EditTestAppoinment)
            {
                ...
                gbRetakeWrittenTest.Enabled = true;
