...
namespace DVLD.Tests.StreetTest
{
    public partial class frmScheduleStreetTest : Form
    {
        ...
        public frmScheduleStreetTest(int LDLAppID, int AppointmentID)
        {
            InitializeComponent();

            this.LDLAppID = LDLAppID;
            TestTypeID = 3; // StreetTest
        ...
        private void FillFrmScheduleStreetTest()
        {
        ...
        private void HandleRetakeTestGroubBox()
        {
            ...
            if (_Mode == enMode.AddNewTestAppoinment || this.AppointmentID == FirstTestAppointmentID)
            {
                ...
                gbRetakeStreetTest.Enabled = false;
            ...
            else if (_Mode == enMode.EditTestAppoinment)
            {
                ...
                gbRetakeStreetTest.Enabled = true;
